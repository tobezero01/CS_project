    ...
    public class DbInitializer
    {
        public static void Initalize(IServiceProvider serviceProvider)
        {
                ...
                GetRequiredService<DbContextOptions<SchoolContext>>()))
            {
                ...
                {
                    new Course { CourseID = 1050, Title = "Introduction to Programming", Credits = 3 },
                    new Course { CourseID = 4022, Title = "Data Structures and Algorithms", Credits = 4 },
                    new Course { CourseID = 4041, Title = "Database Management", Credits = 3 },
                };
