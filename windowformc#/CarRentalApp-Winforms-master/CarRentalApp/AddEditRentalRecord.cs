...
namespace CarRentalApp
{
    public partial class AddEditRentalRecord : Form
    {
        ...
        private void PopulateFields(CarRentalRecord recordToEdit)
        {
            ...
            tbPhone.Text = recordToEdit.Phone.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (isValid)
                {
                    ...
                    rentalRecord.Address = address;
                    rentalRecord.Email = email;
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            dtRented.Text = string.Empty;
            dtReturned.Text = string.Empty;
        ...
        private void tbCost_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                e.Handled = true; // Ngăn ngừa việc nhập ký tự không phải là số
            }
        }
    }
}
